// ignore_for_file: file_names, avoid_print, prefer_adjacent_string_concatenation, prefer_const_constructors
...
//get latest news data list
  ...
  newsItem(int index) {
    ...
    return Padding(
        padding:
            EdgeInsetsDirectional.only(top: 15.0, start: index == 0 ? 5 : 6.0),

...
import 'package:news_app/NewsVideo.dart';
...
class NewsSubDetailsState extends State<NewsSubDetails> {
  ...
  Future<void> _setViews() async {
    // int v = int.parse(widget.model.counter.toString());
    // v = v + 1;
    _isNetworkAvail = await isNetworkAvailable();
    if (_isNetworkAvail) {
      var param = {
      ...
      Response response = await post(Uri.parse(baseUrl + 'setViews'),
  ...
  Future<void> getAd() async {
    ...
    if (_isNetworkAvail) {
      ...
      Response response = await post(Uri.parse(baseUrl + 'get_ads'),
              body: param, headers: headers)
          .timeout(Duration(seconds: timeOut));
  ...
  getUserDetails() async {
    ...
    print("getlocale************${getLocale().toString()}");
                        ...
                        Padding(
                          ...
                          child: Text(
                            ...
                            style: Theme.of(this.context)
                                ...
                                .caption
                                ?.copyWith(
                                    color: colors.primary, fontSize: 9.0),
                          ),
                        )
                      ]),
                  Padding(
                          ...
                          children: [
                            CircleAvatar(
                              ...
                              backgroundImage: NetworkImage(
                                widget.model!.auth_img == null
                                    ? ''
                                    : 'https://swastikitsolutions.in/news/public/images/news/${widget.model!.auth_img}',
                              ),
                            ),
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    padding:
                                        EdgeInsetsDirectional.only(top: 0.0),
                                    child: Text(
                                      widget.model!.auth_name == null
                                          ? 'Metro Bharat'
                                          : 'Reported By: ${widget.model!.auth_name}',
                                      style: Theme.of(this.context)
                                          .textTheme
                                          .caption
                                          ?.copyWith(
  ...
  allDetails() {
    return Padding(
        padding: EdgeInsets.only(top: deviceHeight! / 3.3),
        child: Align(
            alignment: Alignment.bottomCenter,
            child: Container(
              padding:
              ...
              child: Column(
                  ...
                  children: <Widget>[
                    ...
                    descView(),
                    // widget.isDetails!
                    //     ? Text(getTranslated(context, 'com_lbl')!,
                    //         style: Theme.of(context)
                    //             .textTheme
                    //             .subtitle1
                    //             ?.copyWith(
            ...
            child: Container(
              ...
              child: Column(
                  ...
                  children: <Widget>[
                    ...
                    tagView(),
                    titleView(),
                    widget.isDetails! ? dateViewVideo() : Container(),
  ...
  commentView() {
    return comments_mode == "1"
        ? Padding(
            padding: EdgeInsetsDirectional.only(top: 10.0, bottom: 0.0),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                allCommentView(),
